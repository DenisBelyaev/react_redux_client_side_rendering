...
/***/ function(module, exports, __webpack_require__) {
	...
	var _managerRoute = __webpack_require__(639);

	var _managerRoute2 = _interopRequireDefault(_managerRoute);
	...
	module.exports = {
	    ...
	    childRoutes: [{
	        path: '/',
	        component: __webpack_require__(635),
	        childRoutes: [__webpack_require__(639)]
	    }]
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _IndexSidebar = __webpack_require__(636);

	var _IndexSidebar2 = _interopRequireDefault(_IndexSidebar);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var IndexSidebar = function IndexSidebar() {
	    return _react2.default.createElement(
	        'div',
	        null,
	        ...
	        _react2.default.createElement(
	            'ul',
	            null,
	            (0, _data.getAll)().map(function (manager, index) {
	                return _react2.default.createElement(
	                    'li',
	                    { key: manager.status },
	                    _react2.default.createElement(
	                        _reactRouter.Link,
	                        { to: '/manager/' + manager.status },
	                        ' ',
	                        manager.status,
	                        ' '
	                    )
...
/***/ function(module, exports) {
	...
	var dataMap = data.reduce(function (map, manager) {
	...
	module.exports = {
	    ...
	    getComponents: function getComponents(nextState, cb) {
	        __webpack_require__.e/* nsure */(9, function (require) {
	            cb(null, {
	                sidebar: __webpack_require__(642),
	                content: __webpack_require__(643)
	            });
	        });
	    }
	};
